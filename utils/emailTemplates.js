      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb;">
            <tr>
              <td style="background:linear-gradient(135deg,#2E2357,#86BB75);padding:24px;text-align:center;">
                <img src="${LOGO_URL}" alt="${APP_NAME} logo" style="max-height:48px;display:block;margin:0 auto 12px auto;" />
                <h1 style="margin:0;font-size:22px;line-height:1.2;color:#ffffff;">${APP_NAME}</h1>
                <p style="margin:6px 0 0 0;font-size:13px;color:#e5e7eb;">${APP_TAGLINE}</p>
              </td>
            </tr>
            <tr>
              <td style="padding:24px;">
                ...
                <div style="padding:16px;border:1px dashed #d1d5db;border-radius:12px;background:#f9fafb;text-align:center;">
                ...
                <div style="margin-top:20px;padding:16px;border-radius:10px;background:#f3f4f6;">
            ...
            <tr>
              <td style="border-top:1px solid #e5e7eb;padding:16px 24px;background:#fafafa;">
                <p style="margin:0;font-size:12px;color:#6b7280;line-height:1.6;">
                  ...
                  <a href="mailto:${APP_SUPPORT_EMAIL}" style="color:#2E2357;text-decoration:none;">${APP_SUPPORT_EMAIL}</a>
                  or visit <a href="${PLATFORM_URL}" style="color:#2E2357;text-decoration:none;">${PLATFORM_URL}</a>.
                </p>
              </td>
            </tr>
          </table>
...
const buildVerificationCodeEmail = (code) => ({
  html: baseEmailTemplate({
    ...
    preheader: "Use this code to verify your Monexa account.",
    intro:
      "Welcome to Monexa. Use the code below to verify your email address and finish setting up your account.",
    code,
    ...
    footerNote:
      "This email was sent automatically by Monexa account security.",
  }),
  text: `Monexa verification code: ${code}. This code expires in ${CODE_EXPIRY_MINUTES} minutes.`,
});

const buildForgotPasswordCodeEmail = (code) => ({
  html: baseEmailTemplate({
    title: "Reset your password",
    preheader: "Use this code to reset your Monexa password.",
    intro:
      "We received a password reset request for your Monexa account. Use the code below to continue.",
    code,
    expiryText: `Code expires in ${CODE_EXPIRY_MINUTES} minutes.`,
  ...
  text: `Monexa reset code: ${code}. This code expires in ${CODE_EXPIRY_MINUTES} minutes.`,
});
